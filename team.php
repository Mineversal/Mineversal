...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Mineversal Team Page"/>
                ...
                <div class="row text-white text-center team">
                    <div class="col-md-3">
                        <div class="card bg-dark p-4">
                            <img src="assets/img/Azhar.jpg" class="card-img-top" alt="Joe">
                            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="card bg-dark p-4">
                            <img src="assets/img/Nay.jpg" class="card-img-top" alt="Sin">
                            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="card bg-dark p-4">
                            <img src="assets/img/Zidan.jpeg" class="card-img-top" alt="Joe">
                            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="card bg-dark p-4">
                            <img src="assets/img/Sin.jpg" class="card-img-top" alt="Nay">
                            <div class="card-body">
                                <h5 class="card-title">Muhammad Nazmudin Al Maaruf</h5>
